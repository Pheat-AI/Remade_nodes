...
NODE_CLASS_MAPPINGS = {**BLEND_CLASS_MAPPINGS, **OVERLAY_CLASS_MAPPINGS, **REMOVE_BLACK_CLASS_MAPPINGS, **ENLARGED_OVERLAY_CLASS_MAPPINGS}
NODE_DISPLAY_NAME_MAPPINGS = {**BLEND_DISPLAY_NAMES, **OVERLAY_DISPLAY_NAMES, **REMOVE_BLACK_DISPLAY_NAMES, **ENLARGED_OVERLAY_DISPLAY_NAMES}
